...
const frotaRodoviaria = [
  { name: 'Caminhão Basculante',                img: '/Equipamentos/Basculantes Traçados.png',                   alt: 'Locação de Caminhão Basculante Traçado para obras de mineração e construção civil em Minas Gerais' },
  { name: 'Caminhão Guindauto',                 img: '/Equipamentos/Caminhões Munck.jpg',                        alt: 'Locação de Caminhão Guindauto Munck para içamento e movimentação de cargas pesadas industriais' },
  { name: 'Caminhão Comboio/Abastecedor',       img: '/Equipamentos/Caminhões Comboio.png',                      alt: 'Locação de Caminhão Comboio Abastecedor para suporte tático de frotas em campo e mineração' },
  { name: 'Caminhão Pipa',                      img: '/Equipamentos/Caminhões Pipa.png',                         alt: 'Locação de Caminhão Pipa para controle de poeira e abastecimento de água em canteiros de obras' },
  { name: 'Caminhão Carroceria',                img: '/Equipamentos/Caminhões ¾ com cabine suplementar.png',     alt: 'Locação de Caminhão 3/4 com Carroceria e Cabine Suplementar para transporte de equipes e materiais' },
  ...
  { name: 'Roll on Roll off',                   img: '/Equipamentos/Roll on Roll of.png',                        alt: 'Locação de Caminhão Roll on Roll off para movimentação e transporte de equipamentos e plataformas industriais' },
...
const linhaAmarela = [
  ...
  { name: 'Empilhadeira Retrátil',     img: '/Equipamentos/Empilhadeira Retráteis.png',         alt: 'Locação de Empilhadeira Retrátil para operação em corredores estreitos e armazenagem em altura' },
  ...
  { name: 'Trator de Esteira',         img: '/Equipamentos/Tratores de esteira e de pneus.jpg', alt: 'Locação de Trator de Esteira para terraplanagem, mineração e obras em terrenos acidentados em Minas Gerais' },
  ...
  { name: 'Carregadeira',              img: '/Equipamentos/Carregadeiras de grande porte.png',  alt: 'Locação de Carregadeira de Grande Porte para movimentação de materiais a granel em mineração e construção' },
  { name: 'Escavadeira Hidráulica',    img: '/Equipamentos/Escavadeiras Hidráulicas.png',       alt: 'Locação de Escavadeira Hidráulica para mineração, terraplanagem e obras de infraestrutura em Minas Gerais' },
  ...
  { name: 'Manipulador Telescópico',   img: '/Equipamentos/Manipuladores Telescópicos.png',     alt: 'Locação de Manipulador Telescópico para içamento e posicionamento de cargas em obras e indústrias' },
]
